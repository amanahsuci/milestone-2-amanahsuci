...
function initGame() {
    ...
    playerHandImg.src = `../assets/rps_game_pic/${imageList.rock}`;
    computerHandImg.src = `../assets/rps_game_pic/${imageList.rock}`;
...
function playRound(playerChoice) {
    ...
    setTimeout(() => {
        ...
        playerHandImg.src = `../assets/rps_game_pic/${imageList[playerChoice]}`;
        computerHandImg.src = `../assets/rps_game_pic/${imageList[computerChoice]}`;
...
function showChoices(playerChoice, computerChoice) {
    ...
    playerChoiceImg.src = `../assets/rps_game_pic/${imageList[playerChoice]}`;
    playerChoiceImg.alt = playerChoice;
    playerChoiceImg.classList.add('player-choice');

    const computerChoiceImg = document.createElement('img');
    computerChoiceImg.src = `../assets/rps_game_pic/${imageList[computerChoice]}`;
